...
- Follow `DESIGN.md`: mobile-first, premium/trustworthy/practical, Telegram dark-mode base, restrained Telegram Blue accent, Claude-like readable advisor text, no purple AI slop, no flashy fintech styling.
